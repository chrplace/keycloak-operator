...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KeycloakRelatedImages) DeepCopyInto(out *KeycloakRelatedImages) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KeycloakRelatedImages.
func (in *KeycloakRelatedImages) DeepCopy() *KeycloakRelatedImages {
	if in == nil {
		return nil
	}
	out := new(KeycloakRelatedImages)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KeycloakSpec) DeepCopyInto(out *KeycloakSpec) {
	*out = *in
	...
	out.ImageOverrides = in.ImageOverrides
	return
}
