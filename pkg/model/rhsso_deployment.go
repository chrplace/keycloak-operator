...
// GetRHSSOImage checks overrides property to decide the Keycloak image
func GetRHSSOImage(cr *v1alpha1.Keycloak) string {
	if cr.Spec.ImageOverrides.RHSSO != "" {
		return cr.Spec.ImageOverrides.RHSSO
	}
